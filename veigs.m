...
%
% SIGMA is optional. The default value of SIGMA is 'lm'.  
%
% NumOfEigs is optional and specifies the minimum number of eigenvalues to be returned.  
% Default value is 1. 
%
% VEIGS(A,B,SIGMA,NumOfEigs) returns bounds for eigenvalue(s) as below:
...
% Last revision: Clean version (Nov.7.2025)
...
if ischar(SIGMA) || isstring(SIGMA)
    if any(strcmpi(char(SIGMA), {'sm','lm','la','sa'}))
